...
namespace AgremiacionOdontologica.Migrations
{
    ...
    [Migration("20240302185055_asdasd")]
            ...
            modelBuilder.Entity("AgremiacionOdontologica.Controllers.Models.Domicilio", b =>
                {
                    ...
                    b.Property<int>("idOdontologoApellido")
                        .HasColumnType("integer");

                    b.Property<int>("idOdontologoNombre")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("idOdontologoApellido");

                    b.HasIndex("idOdontologoNombre");
            ...
            modelBuilder.Entity("AgremiacionOdontologica.Controllers.Models.Domicilio", b =>
                {
                    ...
                    b.HasOne("AgremiacionOdontologica.Controllers.Models.Odontologo", "odontologoApellido")
                        .WithMany()
                        .HasForeignKey("idOdontologoApellido")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AgremiacionOdontologica.Controllers.Models.Odontologo", "odontologoNombre")
                        .WithMany()
                        .HasForeignKey("idOdontologoNombre")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("localidad");

                    b.Navigation("odontologoApellido");

                    b.Navigation("odontologoNombre");
                });
